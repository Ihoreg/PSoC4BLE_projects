...
#if (CYBLE_L2CAP_MPS == 0u)
    #define CYBLE_L2CAP_MTU_MPS         CYBLE_L2CAP_MTU
#else
    #define CYBLE_L2CAP_MTU_MPS         (CYBLE_L2CAP_MTU / CYBLE_L2CAP_MPS)
#endif /* (CYBLE_L2CAP_MPS == 0u) */
...
/* LL max data length */
#define CYBLE_LL_MAX_SUPPURTED_TX_PAYLOAD_SIZE          (251u)
#define CYBLE_LL_MAX_SUPPORTED_RX_PAYLOAD_SIZE          (251u)
#define CYBLE_LL_MIN_SUPPURTED_TX_PAYLOAD_SIZE          (27u)
...
#define CYBLE_LL_MAX_TX_TIME                            (0x0848u)
        ...
        #define CYBLE_LL_MAX_TX_PAYLOAD_SIZE            (CYBLE_LL_MIN_SUPPURTED_TX_PAYLOAD_SIZE)
        #define CYBLE_LL_MAX_RX_PAYLOAD_SIZE            (CYBLE_LL_MIN_SUPPORTED_RX_PAYLOAD_SIZE)
    #endif  /* CYBLE_M0S8BLESS_VERSION_2 */
#else   /* Use maximum payload size for HCI mode */
    #if(CYBLE_M0S8BLESS_VERSION_2)
        #define CYBLE_LL_MAX_TX_PAYLOAD_SIZE            (CYBLE_LL_MAX_SUPPURTED_TX_PAYLOAD_SIZE)
...
#if((CYBLE_LL_MAX_TX_PAYLOAD_SIZE > CYBLE_LL_MIN_SUPPURTED_TX_PAYLOAD_SIZE) ||\
