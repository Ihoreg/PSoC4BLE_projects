 ...
 */
#define SMP_SC_PAIR_PROP_MITM_MASK              0x01u

/*
 * MASK to set key press in pairing properties for Secure connections.
 */
#define SMP_SC_PAIR_PROP_KP_MASK               0x02u
...
/** Passkey entry notification types.
   These are used for CyBle_GapSecureConnectionKeyNotify API
...
*  ------------                      | -----------
*  CYBLE_ERROR_OK                    | On successful operation.
*  CYBLE_ERROR_INVALID_OPERATION     | Secure connections feature was selected in feature config.
...
***************************************************************************//**
*
* This API is used to send LE Secure connections key press notification to peer device during secure connection pairing.
* This API should be called by application to inform stack about passkey entry process started for each digit:
...
* Error will be returned if key press entry bit was not set in 'pairingProperties' of CYBLE_GAP_AUTH_INFO_T
...
*  \param time: Buffer where time in microseconds will be stored which is 
